...
public class SceneSwitcher : MonoBehaviour
{
    ...
    public void toScene9()
    {
        Invoke("LoadScene9", 0.3f); // Load scene 3 with a 0.3-second delay
    }
    public void toScene10()
    {
        Invoke("LoadScene10", 0.3f); // Load scene 3 with a 0.3-second delay
    }
    ...
    private void LoadScene9()
    {
        SceneManager.LoadScene(9);
    }
    private void LoadScene10()
    {
